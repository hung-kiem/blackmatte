    ...
    BEGIN
        BEGIN
            ALTER TABLE taggable
                DROP CONSTRAINT IF EXISTS taggable_taggable_type_check;
            ALTER TABLE taggable
                ADD CONSTRAINT taggable_taggable_type_check
...
INSERT INTO playlists (name, slug, description, is_public, is_featured, display_order)
VALUES ('Java Programming Tutorials', 'java-programming-tutorials',
        'Complete Java programming course from basics to advanced', true, true, 1),
...
INSERT INTO albums (name, slug, description, is_public, is_featured, display_order)
VALUES ('Vietnam Travel', 'vietnam-travel', 'Beautiful places in Vietnam', true, true, 1),
...
$$
    ...
    BEGIN
        ...
        SET album_id    = vietnam_album_id,
            ...
            status      = 'PUBLISHED',
            is_public   = true
        WHERE LOWER(title) LIKE '%vietnam%'
