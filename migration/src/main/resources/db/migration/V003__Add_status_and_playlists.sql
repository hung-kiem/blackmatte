...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE table_name = 'youtube_videos' AND column_name = 'status'
    ) THEN
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'youtube_videos' AND column_name = 'is_public'
    ) THEN
ALTER TABLE youtube_videos
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'youtube_videos' AND column_name = 'playlist_id'
    ) THEN
ALTER TABLE youtube_videos
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'youtube_videos' AND column_name = 'playlist_order'
    ) THEN
ALTER TABLE youtube_videos
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'youtube_videos' AND column_name = 'duration'
    ) THEN
ALTER TABLE youtube_videos
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'gallery_photos' AND column_name = 'is_public'
    ) THEN
ALTER TABLE gallery_photos
    ADD COLUMN is_public BOOLEAN DEFAULT TRUE;
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'gallery_photos' AND column_name = 'album_id'
    ) THEN
ALTER TABLE gallery_photos
...
END IF;
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.columns
        WHERE table_name = 'gallery_photos' AND column_name = 'album_order'
    ) THEN
ALTER TABLE gallery_photos
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE trigger_name = 'update_playlists_updated_at'
    ) THEN
