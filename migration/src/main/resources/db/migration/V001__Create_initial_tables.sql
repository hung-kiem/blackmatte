    ...
    BEGIN
        IF NOT EXISTS (SELECT 1
                       ...
                       WHERE constraint_name = 'project_images_project_id_fkey'
                         AND table_name = 'project_images') THEN
...
$$
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1
                       FROM information_schema.triggers
                       WHERE trigger_name = 'update_youtube_videos_updated_at') THEN
        ...
        IF NOT EXISTS (SELECT 1
                       FROM information_schema.triggers
                       WHERE trigger_name = 'update_gallery_photos_updated_at') THEN
        ...
        IF NOT EXISTS (SELECT 1
                       FROM information_schema.triggers
                       WHERE trigger_name = 'update_site_settings_updated_at') THEN
